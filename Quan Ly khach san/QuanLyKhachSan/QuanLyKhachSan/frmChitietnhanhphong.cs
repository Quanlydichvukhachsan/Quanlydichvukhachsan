...
namespace QuanLyKhachSan
{
    public partial class frmChitietnhanhphong : Form
    {
        ...
        public frmChitietnhanhphong(ReceiveDTO receiveRoom)
        {
            ...
            customers = (List<CustomerDTO>)CustomersBLL.Instance.readAll();
        ...
        private void btnCapnhatkh_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                {
                   var cus = customers.Find(p => p.IDCard_ == cmnd);
                    if(cus != null)
                    {
        ...
        {
            nameKH = dtfvDanhsachkhachhang[0, e.RowIndex].FormattedValue.ToString();
